...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
              ...
              숨어있을지도 모르는 고던인을 찾아 방을 살핍니다. 모르는
              고던인을 찾습니다. 쥐 죽은 듯이, 지나칠 만큼 조용합니다.
              일어서서는 문 건너편으로 달려 보관함에서 중성자파괴탄을
              찾습니다. 보관함은 비밀번호로 잠겨 있고 중성자파괴탄을 꺼내려면
              비밀번호를 알아내야만 합니다. 비밀번호를 10번 틀리면
              자물쇠는 영원히 잠기고 폭탄은 꺼낼 수 없습니다. 비밀번호는
              3자리 수입니다.
              """))
